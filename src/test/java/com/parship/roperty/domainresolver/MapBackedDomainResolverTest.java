...
public class MapBackedDomainResolverTest {
    ...
    public void setAndGetDomainValues() {
        assertThat(resolver.getDomainKey("dom1"), is("val1"));
    }
    ...
    public void toStringTest() {
        assertThat(resolver.toString(), is("com.parship.roperty.domainresolver.MapBackedDomainResolver with {dom1=val1, dom2=val2}"));
    }
